...
if __name__ == "__main__":
    root_dir = "/afs/crc.nd.edu/user/x/xhu7/Private/research_project/2022/vision_transformer/DATASET/Hippocampus"
    input_dir = root_dir + "/orig"
    target_dir = root_dir + "/preprocessed"
