...
def patchify_augmentation(args, batch):
    ...
    if args.add_contrast_mask:
        ...
        noise_mask = torch.normal(mean=torch.zeros(num_mask * args.mask_scale ** 3, 1, 8, 16, 16),
                                  std=0.1*torch.ones(num_mask * args.mask_scale ** 3, 1, 8, 16, 16))
