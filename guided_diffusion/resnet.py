...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, in_channel=1, strides=(2, 2, 2, 2), dilations=(1, 1, 1, 1)):
        self.inplanes = 64
        super(ResNet, self).__init__()
        self.conv1 = nn.Conv2d(in_channel, 64, kernel_size=7, stride=strides[0], padding=3,
                               bias=False)
